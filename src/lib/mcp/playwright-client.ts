...
export class PlaywrightMCPClient {
  ...
  async start(): Promise<void> {
    ...
    // Always pass --browser explicitly to prevent the MCP server
    // from defaulting to Google Chrome (which may not be installed).
    ...
    const spawnOptions: SpawnOptions = {
      ...
      env: {
        ...process.env,
        // Ensure the MCP server finds the pre-installed browser
